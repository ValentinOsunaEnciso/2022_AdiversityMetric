...
% Experiment 2: Multimodal landscape.
...
dimensiones=100;      % Dimensiones del problema.NOTA:SOLO HASTA 180 DIM.
pop_size=500;       % Tamano de poblacion.
