...
% Experiment 1: Unimodal landscape.
...
modas=1;            % Unimodal: modas=1; Multimodal: modas=2, 4, 8, 16
...
[p1,t,r] = linhyptest(medTot(:,1));
[p2,t,r] = linhyptest(medTot(:,2));
[p3,t,r] = linhyptest(medTot(:,3));
[p4,t,r] = linhyptest(medTot(:,4));
[p5,t,r] = linhyptest(medTot(:,5));
[p6,t,r] = linhyptest(medTot(:,6));
